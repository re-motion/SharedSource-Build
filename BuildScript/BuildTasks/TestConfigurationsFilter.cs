...
namespace Remotion.BuildScript.BuildTasks
{
  public class TestConfigurationsFilter
  {
    ...
    private bool IsSupportedTargetRuntime (string targetRuntime) => _supportedTargetRuntimes.Contains (TargetRuntimeConverter.ToTargetFrameworkMoniker (targetRuntime));
    ...
    private bool HasEnabledConfigurationID (TestConfiguration testConfiguration) => _enabledConfigurationIDs.Contains (testConfiguration.ConfigurationID);
    ...
    {
      var targetFrameworkMoniker = TargetRuntimeConverter.ToTargetFrameworkMoniker (testingConfiguration.TargetRuntime);
