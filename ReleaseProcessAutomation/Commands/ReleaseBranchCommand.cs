...
internal class ReleaseBranchCommand : Command<ReleaseBranchSettings>
{
  private readonly IAnsiConsole _console;
  private readonly IStartReleaseStep _startReleaseStep;
  private readonly ILogger _log = Log.ForContext<ReleaseBranchCommand>();

  public ReleaseBranchCommand (IStartReleaseStep startReleaseStep, IAnsiConsole console)
  {
