...
public class PackContext
{
  ...
  public PackContext (IBaseBuild build, ProjectMetadata project, string configuration, DotNetPackSettings dotNetPackSettings)
  {
    Build = build;
    Project = project;
    Configuration = configuration;
    DotNetPackSettings = dotNetPackSettings;
  }
}