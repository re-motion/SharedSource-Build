...
public interface IBuildMetadata : IBaseBuild
{
  ...
  string GetBaseVersion ()
  {
      ...
      return project.Properties.Single(e => e.Name == "Version").EvaluatedValue;
  }

  void ConfigureBuildMetadata (ImmutableDictionary<string, BuildMetadata>.Builder buildMetadata)
  {
  }
