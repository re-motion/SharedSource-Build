...
{
  public static readonly TestSettings Default = new()
                                                {
                                                    ExecutionRuntimeFactory = new DefaultTestExecutionRuntimeFactory()
                                                };

  public ITestExecutionRuntimeFactory ExecutionRuntimeFactory { get; init; } = default!;

  public ImmutableDictionary<string, string> TestParameters { get; init; } = ImmutableDictionary<string, string>.Empty;
