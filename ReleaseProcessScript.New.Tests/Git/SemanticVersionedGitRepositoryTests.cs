...
namespace ReleaseProcessScript.New.Tests.Git
{
  [TestFixture]
  internal class SemanticVersionedGitRepositoryTests: GitBackedTests
  {
    ...
    public void GetVersionsSorted_With3Versions_ReturnsThemInCorrectOrder ()
    {
      ...
      Assert.That(versions, Is.EqualTo(new SemanticVersion[]
                                       {
    ...
    {
      var gitClient = new CommandLineGitClient(); var readerMock = new Mock<IInputReader>();
