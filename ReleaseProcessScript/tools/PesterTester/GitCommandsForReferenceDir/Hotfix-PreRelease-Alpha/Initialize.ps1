...
git checkout -b "prelease/v2.28.1-alpha.2" *>$NULL
git commit -m "Update metadata to version '2.28.1-alpha.2'." --allow-empty *>$NULL
git tag -a "v2.28.1-alpha.2" -m "v2.28.1-alpha.2" *>$NULL

git checkout "hotfix/v2.28.1" *>$NULL
git merge "prelease/v2.28.1-alpha.2" --no-ff *>$NULL
