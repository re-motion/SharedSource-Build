...
git checkout -b "prelease/v2.28.1-alpha2" *>$NULL
git commit -m "Update metadata to version '2.28.1-alpha2'." --allow-empty *>$NULL
git tag -a "v2.28.1-alpha2" -m "v2.28.1-alpha2" *>$NULL

git checkout "hotfix/v2.28.1" *>$NULL
git merge "prelease/v2.28.1-alpha2" --no-ff *>$NULL

git checkout "hotfix/v2.28.1" *>$NULL
git commit -m "Feature-C" --allow-empty *>$NULL

git checkout -b "prelease/2.28.1-beta.1" *>$NULL
git commit -m "Update metadata to version '2.28.1-beta.1'." --allow-empty *>$NULL
git tag -a "2.28.1-beta.1" -m "2.28.1-beta.1" *>$NULL

git checkout "hotfix/v2.28.1" *>$NULL
git merge "prelease/2.28.1-beta.1" --no-ff *>$NULL
