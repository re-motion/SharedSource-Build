...
function Get-Marker-File ()
{
  ...
  {
    throw ".BuildProject not found. We expect it to be at the .git Repository Top Level '$TopLevelPath'. 
    If your Solution File is not in this Directory either, expect more issues to pop up (see Feature Request RMSRCBUILD-66)"
  }
