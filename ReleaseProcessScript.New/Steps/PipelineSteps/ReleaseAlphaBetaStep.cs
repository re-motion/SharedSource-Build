    ...
    : ReleaseProcessStepBase, IReleaseAlphaBetaStep
{
  ...
  public void Execute (SemanticVersion nextVersion, string? commitHash, bool pauseForCommit, bool noPush)
  {
    ...
    else
    {
      ...
      Serilog.Log.Error($"Cannot call ReleasePreReleaseFromDevelop from a non develop or hotfix/branch. Current branch is '{currentBranch}'");
    ...
    {
      _log.Error($"The branch '{branchName}' already exists while trying to create a new branch with that name");
