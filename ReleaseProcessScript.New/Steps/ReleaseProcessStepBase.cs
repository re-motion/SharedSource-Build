...
namespace ReleaseProcessScript.New.Steps;
...
public abstract class ReleaseProcessStepBase
{
  ...
  protected void EnsureWorkingDirectoryClean ()
  {
    ...
    _log.Error("Working directory not clean, user does not want to continue. Release process stopped");
    throw new Exception("Release processes stopped");
  }
