...
namespace ReleaseProcessScript.New.SemanticVersioning;
...
public class SemanticVersionParser
{
  ...
  public SemanticVersion ParseVersion (string version)
  {
    ...
    {
      _log.Error("Version has an invalid format. Expected equivalent to '1.2.3' or '1.2.3-alpha.4' Input given was: '{Version}'", version);
