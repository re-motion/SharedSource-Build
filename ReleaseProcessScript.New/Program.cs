...
public static class Program
{
  ...
  public static int Main (string[] args)
  {
    ...
    {
      AnsiConsole.WriteException(e.InnerException, ExceptionFormats.ShortenEverything);
      return -1;
    }
    finally
    {
